...
export default function MapDisplay({ center, selectedPosition, onPositionSelect }: { center: [number, number], selectedPosition: [number, number] | null, onPositionSelect: (pos: [number, number]) => void }) {
  useEffect(() => {
