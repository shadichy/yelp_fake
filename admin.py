...
class AppointmentAdmin(ModelView, model=Appointment):
    column_list = [Appointment.id, Appointment.patient_id, Appointment.therapist_id, Appointment.start_time, Appointment.end_time, Appointment.status]
    column_sortable_list = [Appointment.id, Appointment.start_time, Appointment.status]
    column_details_list = [Appointment.id, Appointment.patient_id, Appointment.therapist_id, Appointment.start_time, Appointment.end_time, Appointment.status]
